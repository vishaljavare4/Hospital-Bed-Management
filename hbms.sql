...
--
-- Table structure for table `reserve beds`
--

CREATE TABLE IF NOT EXISTS `rbeds` (
  `rbed_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(150) NOT NULL,
  `ward` varchar(150) NOT NULL,
  PRIMARY KEY (`rbed_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;
...
--
-- Dumping data for table `reserve beds`
--

INSERT INTO `rbeds` (`rbed_id`, `type`, `ward`) VALUES
(1, 'Manual', 'Paediatric'),
(2, 'Semi-Electric', 'Accidents And Emergency'),
(3, 'Full-Electric', 'Psychiatric'),
(4, 'Bariatric', 'Orthopaedic'),
